...
// In PoSV Proof-of-Stake networks, consecutive blocks might have the same state root (no
...
func TestReimportMirroredState(t *testing.T) {
	...
	var (
		...
		engine = New(params.AllPosvProtocolChanges, params.AllPosvProtocolChanges.Posv, db)
