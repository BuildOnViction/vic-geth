...
func TestReimportMirroredState(t *testing.T) {
	...
	var (
		...
		engine = New(params.AllPosvProtocolChanges.Posv, db)
	...
	chain, _ := core.NewBlockChain(db, nil, params.AllPosvProtocolChanges, engine, vm.Config{}, nil, nil)
	defer chain.Stop()

	blocks, _ := core.GenerateChain(params.AllPosvProtocolChanges, genesis, engine, db, 3, func(i int, block *core.BlockGen) {
